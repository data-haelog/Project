...
-- 1. 전체 총 거래 수
SELECT COUNT(*) AS total_transactions FROM online_retail;

-- 2. 총 매출
SELECT SUM(TotalPrice) AS total_revenue FROM online_retail;
...
-- 5. 취소 거래 수
SELECT SUM(IsCancelled) AS total_cancellations FROM online_retail;
